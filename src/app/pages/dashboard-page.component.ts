      ...
      <section class="container dashboard-container">
        @if (loading()) {
          ...
          <header class="dashboard-header">
            ...
            <div class="header-actions"><button class="button secondary" (click)="showUploadModal()">Enviar documento</button>@if (isAdmin()) { <button class="button" (click)="showUserModal()">Novo usuário</button> }</div>
          </header>
