...
export interface SignatureRequest { id: string; document_id: string; document_version: number; status: string; expires_at: string; signer_count: number; signed_count: number; signing_url: string; }
...
export interface UserCreated { id: string; email: string; role: string; is_active: boolean; }
